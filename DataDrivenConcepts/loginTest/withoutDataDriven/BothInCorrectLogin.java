...
public class BothInCorrectLogin {

	
	// using parameter tab to pass the data from XML file 
	@Test @Parameters({"username", "password"})
	private void loginWithInCorrectData(String uName, String pWord) throws InterruptedException {
